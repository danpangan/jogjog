...
public class blueMapProperty extends DialogFragment implements OnMapReadyCallback {

    Button btn_back_map_property;
    private GoogleMap mMap;

    public static blueMapProperty newInstance() {
        blueMapProperty mapDialog = new blueMapProperty();
        return mapDialog;
    }
